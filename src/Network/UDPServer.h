...
private:
    ...
    void start_receive();
    void handle_receive(RefPtr<std::array<char, s_max_message_size>>,
        ServerSideUDPClient,
        const boost::system::error_code& error,
        size_t /*bytes_transferred*/);
    void handle_send(RefPtr<std::array<char, s_max_message_size>>,
...
public:
    ...
    [[deprecated]] void send_to_all(RefPtr<std::array<char, s_max_message_size>> data, size_t size);
    [[deprecated]] void send_to_all(RefPtr<std::array<char, s_max_message_size>> data, size_t size, ServerSideUDPClient ignore);
    void send_to(RefPtr<std::array<char, s_max_message_size>> data, size_t size, ServerSideUDPClient target);

    std::function<std::optional<std::array<char, s_max_message_size>>(ServerSideUDPClient, RefPtr<std::array<char, s_max_message_size>>, size_t)> on_receive { nullptr };
